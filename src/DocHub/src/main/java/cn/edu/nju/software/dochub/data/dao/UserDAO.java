 ...
 * 
 * @see cn.edu.nju.software.dochub.data.dataobject.User
...
public class UserDAO extends HibernateDaoSupport {
	...
	public List<User> findByPermissionLevel(Object permissionLevel) {
		return findByProperty(PERMISSION_LEVEL, permissionLevel);
	}

	public List<User> findByActive(Object active) {
