 ...
 * @see cn.edu.nju.software.dochub.data.dataobject.Tag
 */
...
public class TagDAO extends HibernateDaoSupport {
    ...
    public Tag findById(java.lang.Integer id) {
        ...
        try {
            Tag instance = (Tag) getHibernateTemplate().get(
                    "cn.edu.nju.software.dochub.data.dataobject.Tag", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<Tag> findByExample(Tag instance) {
        ...
        try {
            List<Tag> results = (List<Tag>) getHibernateTemplate()
    ...
    public Tag merge(Tag detachedInstance) {
        ...
        try {
            Tag result = (Tag) getHibernateTemplate().merge(detachedInstance);
