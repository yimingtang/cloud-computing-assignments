			...
			<div class="panel-body" id="panel-body">
				...
				<form class="form-horizontal" role="form">
					<div class="form-group">
						<div style="visibility:hidden"><input id="inputDocId" value="$document.getId()"/></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<div class="input-group">
								<input type="text" class="form-control" id="inputPublisher" value="$document.getPublisher()">
