      ...
      <div class="row">
        <div class="col-xs-12 col-md-9">
          <nav>
            <ol class="breadcrumb">
              <li><a href="/document/index.html"><span class="glyphicon glyphicon-home"></span> 首页</a></li>
              <li><a href="/admin/user/index.html">管理</a></li>
        ...
        <div class="col-xs-12 col-md-3">
          ...
          <div class="list-group">
              <a href="/admin/user/index.html" class="list-group-item">用户管理</a>
              ...
              <a href="/admin/tag/index.html" class="list-group-item active">标签配置</a>
          </div><!-- /.list-group -->
